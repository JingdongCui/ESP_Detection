...
#define UI_TRACE(step) ESP_LOGI("setup_ui", "%s stack_hwm=%u", step, (unsigned)uxTaskGetStackHighWaterMark(NULL))
...
static lv_obj_t * create_ui(void) {
    ...
    UI_TRACE("create_ui background done");
    // Create scr_dashboard_cont_log
    UI_TRACE("create_ui log begin");

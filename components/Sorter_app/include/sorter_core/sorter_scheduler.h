...
typedef struct {
    sorter_event_type_t type;
    union {
        sorter_motor_command_t motor;
        struct {
            size_t active_count;
...
typedef int (*sorter_event_fn_t)(void *ctx, const sorter_event_t *event);
...
void sorter_scheduler_set_event_handler(sorter_scheduler_t *scheduler, sorter_event_fn_t event_fn, void *ctx);

...
图 1 三段传送带与摄像头安装布局，主传送带负责识别与前级输送，两侧传送带负责分类输出。

![上位机视觉检测界面](report_assets/host_page_2_detection.png)

图 2 上位机视觉检测界面，显示包裹图像、面单框、Logo 检测框、分类结果和历史记录。
...
图 3 摄像头安装在传送带上方约 60 cm 位置，通过手动调焦保证面单和 Logo 区域清晰成像。
...
图 4 ESP32-P4 板端安装在机架背面，线束沿结构件固定，便于将摄像头、显示、传感器和电机控制信号引出到各功能模块。

![电源板与电机驱动板实物接线](report_assets/hardware_power_driver_board.jpg)

图 5 电池、电源板和电机驱动板实物接线图，用于展示模块化电源与执行机构连接方式。

主要硬件资料图如下：

![XL4015 四通道降压电源板参数](../1.jpg)

![直流电机驱动板接口说明](../4.jpg)

![42GM-775 直流减速电机规格](../7.jpg)

![12V/24V 电机参数对比](../8.jpg)

![3A DC-DC 多路电源模块参数](../11.jpg)
...
![主动/从动滚筒尺寸图](../2b9b7d1216bb0c666e4a67f205c1bf1d.jpg)

![4080 铝尾座尺寸图](../4b210e605cd33f5b49de57c7b02b2b84.jpg)

![4080 铝头座尺寸图](../7ddf6ca2ba23b66577575f13253528bd.jpg)

![4080 国标铝型材尺寸图](../7e5328ddb76a2681f0dd24bce1040a4a.jpg)
...
图 6 上位机性能总览界面，显示连接状态、CPU/PSRAM/内存占用、运行时长和分类统计。

![上位机视觉检测界面](report_assets/host_page_2_detection.png)

图 7 上位机视觉检测界面，显示包裹图像、面单框、Logo 检测框、分类置信度和包裹图像记录。

![上位机设备控制界面](report_assets/host_page_3_control.png)

图 8 上位机设备控制界面，用于调整屏幕亮度、置信度阈值、电机转速和检测显示开关。

![上位机系统维护界面](report_assets/host_page_4_system.png)

图 9 上位机系统维护界面，显示监听状态、链路端口、保存目录、运行日志和图片链路健康状态。
...
| 素材 | 使用位置 | 说明 |
| --- | --- | --- |
| `report_assets/conveyor_layout_photo.jpg` | 1.1、3.1 | 三段传送带布局实拍 |
...
| `report_assets/host_page_4_system.png` | 2.3 | 上位机系统维护页 |

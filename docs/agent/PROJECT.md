...
- 2026-07-08 `docs/competition_report_draft.md` 已扩充为接近可交付版，包含现有图片、PSRAM 蓝屏优化、模型训练/量化心得和缺图清单；定稿仍需补系统整体正式图、实际分拣图、板端 UI 正面清晰图。
- 2026-07-08 后续补图已加入报告：系统正面实拍、实际分拣过程实拍、板端仪表盘/设置/日志/系统资源 UI；当前主要缺图转为系统框图图片版、传感器局部图、数据集样例/训练曲线/量化对比表。

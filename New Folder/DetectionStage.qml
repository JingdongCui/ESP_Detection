...
PremiumPanel {
    ...
    Item {
        ...
        readonly property real imageScale: frameImage.sourceSize.width > 0 && frameImage.sourceSize.height > 0
            ? Math.min(width / frameImage.sourceSize.width, height / frameImage.sourceSize.height)
            : 0
        readonly property real displayWidth: frameImage.sourceSize.width * imageScale
        readonly property real displayHeight: frameImage.sourceSize.height * imageScale
    ...
    Repeater {
        ...
        delegate: Rectangle {
            ...
            x: 18 + imageViewport.displayX + Number(modelData.x || 0) * imageViewport.displayWidth
            y: 18 + imageViewport.displayY + Number(modelData.y || 0) * imageViewport.displayHeight
